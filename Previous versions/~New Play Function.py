...
async def queue(ctx):
  #for queueNum in Squeue:
  await ctx.send(f"There are {len(Squeue)} songs\n You should know the songs that you entered, idiot")
